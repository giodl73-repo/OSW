...
def test_column_viewer_accessible_interaction_contract():
    ...
    for token in ('id="province-select"', 'id="band-controls"', 'id="overlay-controls"', 'id="seed-status"', 'id="neighborhood-canvas"', 'id="footprint-canvas"', 'id="footprint-depth-profile"', 'id="footprint-profile-label"', 'id="footprint-map-label"', 'id="footprint-map-legend"', 'id="footprint-passport"', 'id="depth-ladder-canvas"', 'id="depth-ladder-legend"', 'id="depth-ladder-summary"', 'data-neighborhood-mode="depth"', 'data-neighborhood-mode="source"', 'data-footprint-profile="volume"', 'data-footprint-profile="seafloor"', 'data-footprint-map="family"', 'data-footprint-map="area"', 'data-footprint-map="volume"', 'data-footprint-map="depth"', 'data-footprint-map="floor"', 'data-footprint-map="band"', 'aria-live="polite"', 'role="img"', "Evidence boundary", "not a province mean", 'src="neighborhoods.js"', 'src="province-footprints.js"', 'src="province-fingerprints.js"'):
        assert token in html
    for token in ("OSW_PROVINCE_FINGERPRINTS", "history.replaceState", "matchMedia", 'event.key === "Enter"', "aria-pressed", "updateReadout", "renderNeighborhood", "renderFootprint", "renderDepthLadder", "bandShareColor", "renderPassport", "ranksFor", "rankColor", "selectedBandInfo", "rankLegendEntries", "floor_character", "substantial_seafloor_band_count", "volume_rank_advantage_over_area", "wet_area_fraction_by_seafloor_band", "water_volume_fraction_by_depth_band", "sampled_water_volume_km3", "not a detected physical regime", "does not reach this band", "bathymetry-truncated part", "not province-wide", "not the province", "overlaySentence"):
        assert token in app
